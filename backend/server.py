...
async def create_task(loop_id: str, task_data: TaskCreate, current_user = Depends(get_current_user)):
    ...
    task_doc = {
        ...
        "assigned_email": task_data.assigned_email,
    ...
    return TaskResponse(
        ...
        assigned_email=task_doc.get("assigned_email"),
